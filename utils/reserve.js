...
export function fetchIconSymbolAndName({ underlyingAsset, symbol, name }) {
  // guni symbols are just broken (G-UNI for all tokens)
  if (underlyingAsset.toLowerCase() === "0x50379f632ca68d36e50cfbc8f78fe16bd1499d1e".toLowerCase()) {
    return { iconSymbol: "GUNI_DAI_USDC", name: "G-UNI DAI/USDC", symbol };
  }
  if (underlyingAsset.toLowerCase() === "0xd2eec91055f07fe24c9ccb25828ecfefd4be0c41".toLowerCase()) {
    return { iconSymbol: "GUNI_USDC_USDT", name: "G-UNI USDC/USDT", symbol };
  }
  if (underlyingAsset.toLowerCase() === "0xa693B19d2931d498c5B318dF961919BB4aee87a5".toLowerCase()) {
...
export const STABLE_ASSETS = ["DAI", "TUSD", "BUSD", "GUSD", "USDC", "USDT", "EUROS", "FEI", "FRAX", "PAX", "USDP", "SUSD", "UST", "EURS", "JEUR", "AGEUR", "LUSD", "MAI"];
