...
export default function ViewSimulation() {
  ...
  <td className="py-4 text-center justify-center flex items-center">
    {userReserveData.usageAsCollateralEnabledOnUser ? (
      ...
      "-"
                                ...
                                <td>
                                  ...
                                  <ButtonOutlined className={'px-1 text-xs'} label="Withdraw" onClick={() => onOpenWithDrawModal(userReserveData)} disabled={rangeValue < lastKey}/>
                                    <ButtonOutlined className={'px-1 text-xs'} label="Swap" onClick={() => onOpenSwapSupplyModal(userReserveData)} disabled={rangeValue < lastKey}/>
                                  </div>
                                </td>
                              </tr>
                            );
    ...
    <ButtonOutlined
        ...
        disabled={rangeValue < lastKey|| asset.availableToDeposit <= 0}
    />
                                  <ButtonOutlined className={'px-2 text-xs'} label="Add"  onClick={() => onOpenAddModal(asset)} disabled={rangeValue < lastKey}/>
                                  </div>
                                </td>
                              </tr>
                            )
                            ...
                            return (
                              <Fragment key={"userReservesVariable" + indexData}>
                                <tr className="border-b text-xs border-light-hover dark:border-gray-700">
                                  ...
                                  <td>
                                    <div className="flex gap-1 justify-between">
                                    <ButtonOutlined className={'px-2 text-xs'} label="Repay" onClick={() => onOpenRepayModal(userReserveData, "variable")} disabled={rangeValue < lastKey}
      />
                                    </div>
                                  </td>
                                </tr>
                                <tr key={"userReservesStable" + indexData} className="border-b text-xs border-light-hover dark:border-gray-700">
                                  ...
                                  <td>
                                    <div className="flex gap-1 justify-between">
                                    <ButtonOutlined className={'px-2 text-xs'} label="Repay" onClick={() => onOpenRepayModal(userReserveData, "stable")} disabled={rangeValue < lastKey}
      />
                                    </div>
                                  </td>
                                </tr>
                          ...
                          if (userReserveData.stableBorrows != 0) {
                            return (
                              <tr key={"userReserves" + indexData} className="border-b border-light-hover dark:border-gray-700 text-xs">
                                ...
                                <td>
                                  <div className="flex gap-1 justify-between">
                                 <ButtonOutlined className={'px-2 text-xs'} label="Repay" disabled={rangeValue < lastKey}/>
                                 <ButtonOutlined className={'px-2 text-xs'} label="Borrow" onClick={() => onOpenBorrowModal(userReserveData)} disabled={rangeValue < lastKey}/>
                                  </div>
                                </td>
                              </tr>
                            );
                          ...
                          if (asset.availableToDeposit != 0) {
                            return (
                              <tr className="border-b text-xs border-light-hover dark:border-gray-700" key={"assetSupply" + index}>
                                ...
                                <td>
                                  <div className="flex gap-1 justify-between">
                             <ButtonOutlined className={'px-2 text-xs'} label="Borrow" disabled={rangeValue < lastKey} onClick={() => onOpenBorrowModal(asset)} />
                                  </div>
                                </td>
                              </tr>
                            )
